...
$list_name = $_POST['list_name'][$rowz] ;
$remark= $_POST['remark'][$rowz] ;
$score= $_POST['score'][$rowz] ;

$SQL="UPDATE  `vt_tracker`.`tb_check_list` SET  `list_name` =  '$list_name',
`remark` =  '$remark',
`score` =  '$score' WHERE  `si` ='$checkbox' ";

//die ($SQL) ;
$obj->sql($SQL);

$a="<font color='green'>Check List Update Successfully .</font>" ;
