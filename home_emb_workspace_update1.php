...
$emb_cut_panel = $_POST['emb_cut_panel'][$rowz] ;
$emb_cut_panel_dlv = $_POST['emb_cut_panel_dlv'][$rowz] ;
$emb_comnt = $_POST['emb_comnt'][$rowz] ;
$emb_status= $_POST['emb_status'][$rowz] ;
$emb_type= $_POST['emb_type'][$rowz] ;


$SQL="UPDATE  `tb_track_info` SET  emb_cut_panel= '$emb_cut_panel',
emb_cut_panel_dlv = '$emb_cut_panel_dlv',
emb_emb_type = '$emb_type',
emb_id = '$uid',
emb_date='$sys_date' ,
emb_comnt = '$emb_comnt',
...
<form action="home_emb_workspace_update1.php" method="post" enctype="multipart/form-data">    
       
<table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:1500px; padding-bottom: 10px; background-color: #FFF; color: #FC0;">
    ...
    <th align="center" style="width:55px; background-color:#CCCCFF">Emb. Cut Panel Rcv</th>
    <th style="background-color:#CCCCFF">Emb. Cut Panel Dlv</th>
    <th style="background-color:#CCCCFF">Emb. Comt</th>
    <th style="background-color:#CCCCFF">Emb. Status</th>
    <th style="background-color:#CCCCFF">Emb. Type</th>
    <th style="width:100px">SD Comt</th>
    <th style="width:100px">DPD Comt</th>  
    <th style="width:100px">MM Comt</th> 
    <th>Sample</th>
	<th style="width:100px">Embroidery Comt</th> 
	</tr>
	...
	?>
		...
		<tr class="gradeA">
		  ...
		  <td><input name="emb_cut_panel[]" onClick="select()" value="<?php echo $row['emb_cut_panel'] ; ?>" size="10px" tabindex="1"></td>
		  <td><input name="emb_cut_panel_dlv[]" onClick="select()" value="<?php echo $row['emb_cut_panel_dlv'] ; ?>" size="15px" tabindex="2"></td>
		  <td><textarea name="emb_comnt[]" onClick="select()" tabindex="3" rows="3" cols="20" ><?php echo $row['emb_comnt'] ; ?></textarea></td>
         <td><select name="emb_status[]" id="emb_status" tabindex="4">
         ...
         <td><select name="emb_type[]" tabindex="5">
