...
-->
     ...
     <!--<select name="labdip[]" id="labdip[]" autofocus required >
       ...
       <option value="Pending">Pending</option>
        ...
        <td scope="row"><textarea name="collar_size[]" cols="9" rows="3" placeholder="Collar Size"></textarea></td>
        ...
        <td scope="row"><textarea name="cuff_size[]" cols="9" rows="3" placeholder="Cuff Size"></textarea></td>
...
document.getElementById('attachment').addEventListener('change', handleFileSelect, false);
    ...
    <!--<div align="center" style="background-color:#FFFFCC">-->
    <div align="center">
    <input class="btn btn-success" name="Next" type="submit" />
    <input class="btn btn-danger" type="reset" name="Reset" id="button" value="Reset" />
    </div>
    </form>
    </div>
...
<?php if($delv_qty!=NULL && $sto_po_no!=NULL){ $cs = '3'; } if($delv_qty==NULL && $sto_po_no!=NULL){ $cs = '2'; } if($delv_qty==NULL && $sto_po_no==NULL){ $cs = '1'; } ?>
 ...
 <!--   <td scope="row"><?php // echo $row['sd_sample_type_name'] ;  ?></td>-->
    ...
    <ul class="thumb">
    <li class="redshadow">
         <a href="<?php echo $row['attachment'] ; ?>" data-link="mylink.html"><img alt="Buyer: <strong><?php echo $row['buyer'] ; ?></strong> Style: <strong><?php echo $row['sample_style'] ; ?></strong> Season: <strong><?php echo $row['season'] ; ?></strong> Color: <strong><?php echo $row['color'] ; ?></strong>" src="<?php echo $row['attachment'] ; ?>" /></a>
