...
<div width="80%"  style="margin-top:5px; ">
  ...
  <tr align="center" style="font-weight:bold; font-size:11px">
    <td bgcolor="#CCFFCC">Fab Color</td>
    <td bgcolor="#CCFFCC"><input name="search_fab_color" value="<?php echo $search_fab_color; ?>" type="text" placeholder="Fabric Color" /></td>
    <td>Concern DPD</td>
    <td><input name="search_dpd" type="text" value="<?php echo $search_dpd; ?>" placeholder="DPD Name" /></td>
    <td bgcolor="#CCFFCC">STO Create Date From</td>
    <td bgcolor="#CCFFCC"><input name="search_mm_date1" value="<?php echo $search_mm_date1; ?>" class="rounded" type="text" placeholder="dd-mm-yyyy" tabindex="2" onclick="showCalendarControl(this);" /></td>
    <td>STO Create Date TO</td>
    <td><input name="search_mm_date2" value="<?php echo $search_mm_date2 ; ?>" class="rounded" type="text" placeholder="dd-mm-yyyy" tabindex="2" onclick="showCalendarControl(this);" /></td>
    </tr>
  </table>
...
//	$results  = $obj->sql($SQL);
	...
	$sql="select a.*,b.fab_receive_planned_date,b.customer,b.sd_sample_type_name,b.sd_agreed_sample_delivery_date, b.sd_concern_dpd_name,a.sl as sll,a.color_code as c_code, b.sd_concern_dpd_name from tb_fabric_booking a LEFT JOIN tb_track_info b ON a.track_info_sl = b.sl WHERE a.sl != ''";    //table name
    ...
    <tr id="<?php echo $row['sll'] ; ?>" class="edit_tr">
      <?php } ?>    
		  		...
		  		<td<?php if($revise_status != 0) { ?> bgcolor="#88E4EC" <?php } ?>><label><input name="checkbox[]" type="checkbox" class="checkbox1" id="checkbox[]" value="<?php echo $row['sll']; ?>~<?php echo $row['sto_po_no']; ?>~<?php echo $row['sd_concern_dpd_name']; ?>"></label></td>
