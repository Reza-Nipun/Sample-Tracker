<?php
	...
	if (isset($_POST['Submit']))
 		{
	$slid=$_POST['slid'] ;
	$dying_cmt=$_POST['dying_cmt'];
	$status=$_POST['status'];
	
	
	$SQL="UPDATE  `tb_fabric_booking` SET  `del_status` =  '$status',
`remark_dy` = '$dying_cmt' WHERE  `tb_fabric_booking`.`sl` ='$slid'" ;
...
<h2 align="center"> Dying Fabrig Comment Update</h2>

<br />
<?php echo $msg ; ?>

<form action="home_dying_cmt_update.php" method="post">
...
//die($SQL);
  ...
  <tr>
    ...
    <td scope="row"><textarea name="dying_cmt" id="dying_cmt"><?php echo $row['remark_dy'] ; ?></textarea></td>
  </tr>
  <tr>
    <td bgcolor="#E5E5E5" scope="row">Status</td>
    <td scope="row"><select name="status" id="status">
