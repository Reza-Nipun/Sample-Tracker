...
<th bgcolor="#88E4EC" style="color:#F00"><strong>Fab Wash</strong></th>
...
<tr>
       <!-- <td><input type="hidden" name="" size="2" value="" class="search_init" /></td>-->
          ...
          <td><input type="text" name="Gray GSM" size="15" value="Gray GSM" class="search_init" /></td>
...
$sql= $sql . " AND a.knit_status NOT IN ('Complete', 'Cancelled') AND a.sto_po_no!='' group by a.sl order by sll, length(sll) ASC LIMIT 0, 5" ;
