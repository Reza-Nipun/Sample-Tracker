...
.login-popup {
    display:none;
    background: #fff;
	background-image:url(../EID/eid-mubarak-timeline-cover-picture-for-facebook.jpg);
...
<a href="index_b4_eid.php" class="close" style="width:40px" title="Close the Greetings!!! Thank You."><img src="../EID/close_pop1.png" class="btn_close" title="Close Window" alt="Close" /></a>
     <h2 style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:34px; text-align:center">  &nbsp; &nbsp;
      <script>
