<?php
	...
	if($user_rule == 13)
	{
        header("location:home_sd_all.php");
	}
...
<script src="media/js/sorttable.js"></script>
	...
	document.getElementById("fabric_type_chosen").style.width = '200px';
...
<body>
  ...
  <tr align="center" style="font-weight:bold; font-size:11px">
    ...
    <td width="12%">
    <select name="sd_concern_sd_name" autofocus id="sd_concern_sd_name" data-rel="chosen" style="font-size:11px">
