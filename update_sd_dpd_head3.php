...
$row=0;
foreach($_POST['namer'] as $rowz=>$name)
{
...
$SQL="INSERT INTO tb_sample_status (`sl`, `brand_style`,`t_sl`,color, `sample_status_event`, `sample_status_objective`, `update_date`, `user`) VALUES ('', '$brand_style_get','$sl','$color', 'Responsible Person Rejection', '$namer', '$datex', '$uid')" ;
//die($SQL);
$obj->sql($SQL);	
