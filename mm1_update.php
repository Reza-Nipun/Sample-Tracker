...
if($sl==NULL OR $update_brand_style==NULL OR $user_rule!=2)
{
...
$mm_fabric_booking_by_dpd_to_mm_date_post=mysql_real_escape_string($_POST['mm_fabric_booking_by_dpd_to_mm_date']);

if($mm_fabric_booking_by_dpd_to_mm_date!=NULL)
{
	die('ERROR!!!.Data already Update.');
}

if(strlen($mm_fabric_booking_by_dpd_to_mm_date_post)>0)
{
$SQL="UPDATE `tb_track_info` SET mm_fabricbooking_by_dpd_to_mm_date = '$mm_fabric_booking_by_dpd_to_mm_date_post' WHERE `tb_track_info`.`sl` ='$sl' AND brand_style='$update_brand_style'" ;
$obj->sql($SQL);	
				...
				<?php require("re_header_page.php"); ?>
                    ...
                    <div class="container"> 
                        <div class="row"> 
                          ...
                          <section class="span6">
                           <p><?php echo $msg ; ?></p>
							<p>Go back to <a style="color:#03F" href="update_mm.php?ID=<?php echo $sl ; ?>&ID1=<?php echo $update_brand_style ; ?>"  title="Update">Previous page</strong> </a></p>
