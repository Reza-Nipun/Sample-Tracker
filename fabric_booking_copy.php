...
<h3 align="center">Copy Fabric Booking of Style <?php echo $style ; ?></h3>
<br />
...
<tr>
  ...
  <tr>
    ...
    <td scope="row">
    <?php if($combo == NULL) { ?>
	 <input name="f_color[]" value="<?php echo $fab_color ;  ?>" type="text" placeholder="Fab Color" tabindex="2" size="8"  id="f_color[]">
    <?php } if($combo != NULL) { ?><textarea name="f_color[]" placeholder="Fab Color" rows="3" cols="20" ><?php echo $fab_color; ?></textarea><?php } ?>      
    </td>
    <td scope="row"><textarea name="c_code[]" cols="30" rows="3" id="c_code[]" autofocus required placeholder="Color Code"><?php echo $color_code; ?></textarea>
    </td>
   <!-- <td scope="row">
 ...
 <td scope="row"><textarea name="labdip[]" cols="9" list="characters8" rows="3" id="labdip[]" autofocus required placeholder="Lab Dip"><?php echo $labdip; ?></textarea></td>
    ...
    <td scope="row"><textarea name="collar_des[]" cols="9" rows="3" placeholder="Collar Des"><?php echo $collar_des; ?></textarea></td>
            <td scope="row"><textarea name="collar_size[]" cols="15" rows="3" placeholder="Size/Fabrication"><?php echo $collar_size ; ?></textarea></td>
   ...
   <td scope="row"><textarea name="cuff_size[]" cols="15" rows="3" placeholder="Size/Fabrication"><?php echo $cuff_size; ?></textarea></td>
    ...
    <td scope="row"><textarea name="dpd_cmt[]" cols="9" rows="3" id="dpd_cmt[]" placeholder="dpd Comm."><?php echo $remark_dpd; ?></textarea></td>
...
<?php if($delv_qty!=NULL && $sto_po_no!=NULL){ $cs = '3'; } if($delv_qty==NULL && $sto_po_no!=NULL){ $cs = '2'; } if($delv_qty==NULL && $sto_po_no==NULL){ $cs = '1'; } ?>
 ...
 <!--   <td scope="row"><?php // echo $row['sd_sample_type_name'] ;  ?></td>-->
    ...
    <td <?php if($cancel_status !=0) { ?> style="color:#F00"<?php } if ($revise_status != 0) {?>style="font-size:14px; font-weight:bold"<?php } ?>><?php echo $row['fab_wash'] ; ?></td>
