<?php
	...
	$SQL="UPDATE  `tb_track_info` SET dpd_clarification_sending_to_sd_date='$dpd_clarification_sending_to_sd_date',sd_actual_sample_submission_date='$sd_actual_sample_submission_date',mm_fabricbooking_by_dpd_to_mm_date='$mm_fabricbooking_by_dpd_to_mm_date',sd_sample_reject_pass='$sd_sample_reject_pass',cmt_dpd='$cmt_dpd',update_dpd_id='$update_dpd'WHERE  `tb_track_info`.`sl` ='$checkbox' ";
