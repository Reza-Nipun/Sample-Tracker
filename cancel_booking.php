...
<form action="cancel_booking_save.php" method="post">   
...
?>
  ...
  <tr>
    ...
    <td scope="row"><textarea name="cancel_cmnts" rows="3" cols="40" onclick="select()" required autofocus>N/A</textarea><input name="fab_sl" type="hidden" value="<?php echo $id; ?>" /><input name="cancel_status" type="hidden" value="<?php echo $cancel_status; ?>" />
      <input name="tsl" value="<?php echo $tsl; ?>" type="hidden" /></td>
  </tr>
