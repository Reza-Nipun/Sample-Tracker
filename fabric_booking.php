...
<div style="margin-left:30px">
    ...
    <details>
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="bottomBorder" id="gradientstyle">
            ...
            <td scope="row"><select name="s_color[]" autofocus required id="s_color[]" tabindex="1" style="font-size:11px">
             <option value="" selected="selected">Gmt Color</option>
              <?php
               ...
               $SQL="select sl, color, sd_sample_type_name from tb_track_info where style like '$style' AND season='$season' AND sd_concern_dpd_name = '$user_name' AND sd_sample_reject_pass = '' ORDER BY sl DESC";
               //die($SQL);
                      $obj->sql($SQL);
                      while($row = mysql_fetch_array($obj->result))
                      { 
          ...
          <input name="f_color[]" placeholder="Fab Color" type="text" tabindex="2" size="8" id="f_color[]" autofocus required >
            ...
            <select name="fabrication[]" id="fabrication" tabindex="3" style="font-size:11px" autofocus required >
    ...
    -->
            ...
            <select name="comments[]" id="comments" style="font-size:11px" required autofocus >
    ...
    <br />
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="bottomBorder"  id="gradientstyle">
          ...
          <tr>
            ...
            <select name="comments" id="comments_yd" style="font-size:11px" required autofocus >
...
//	$SQL="select * from tb_fabric_booking where sample_style='$style' AND season='$season'";    //table name
	...
	if($cancel_status !=0) { $stl = "color:#F00; "; }
	if($revise_status != 0) { $stl = $stl+"font-size:14px; font-weight:bold";}
...
<td <?php echo "style='$stl'"; ?> title="Create Date - <?php echo $row['dpd_date'] ;  ?>"><?php echo $row['sample_style'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['color'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['item_cat'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['fabrication'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['gsm'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['fab_wash'] ;  ?></td>
<td <?php echo "style='$stl'";?> bgcolor="#FFFFCC"><?php echo $row['dpd_req_qty'];?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['uom'];?></td>
<td align="center" <?php echo "style='$stl'";?>><?php echo $row['composition'];?></td>
<td align="center" <?php echo "style='$stl'"; ?>><?php echo $row['fab_color'];?></td>


<td align="center" <?php echo "style='$stl'"; ?>><?php echo $row['color_code'];?></td>
<td align="center" <?php echo "style='$stl'"; ?>><?php echo $row['remarks'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['comments'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['labdip'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['collar_des'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['collar_size'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['collar_color'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['collar_qty'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['cuff_des'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['cuff_size'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['cuff_color'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['cuff_qty'] ; ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['dia'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['yarn_count'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['supplier'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['remark_dpd'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['sto_po_no'] ;  ?></td>
<td <?php echo "style='$stl'"; ?>><?php echo $row['referrence_id'] ;  ?></td>
    ...
    <br/>
	   ...
	   <div align="center" style="margin-left:500px">
            <div align="center" style="float:left">
            	<button class="btn btn-inverse" id="exl_dwnld" style="cursor:pointer">Click to download as Excel</button>  
