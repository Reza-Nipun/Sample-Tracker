	...
	<body>
		...
		<div id="demo" style="margin-top:20px; ">
			<form action="home_dpd_update1.php" method="post" enctype="multipart/form-data">
				<table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:4800px !important; padding-bottom: 10px; background-color: #FFF; color: #FC0;">
					...
					<thead>
						<tr bgcolor="" style="color:#000; font-family:'Courier New', Courier, monospace; font-weight:normal">
							...
							<th style="background-color:#F70">Clarificaition of Missing Info Sending to SD (Date)<span style="color:#F00; font-size:16px">****</span></th>
							...
							<th style="width:125px !important;background-color:#F90">Sample Sewing Starts Planned (Date)<span style="color:#F00; font-size:16px">****</span></th>
							<th style="">Sample Sewing Starts Actual (Date)</th>
							<th style="">Sample Request Rcv Date</th>
							...
							<th style="width:115px !important;background-color:#F90">Fabric Recv Planned-(Date)</th>
							<th style="background-color:#F70">Fabric Booking By DPD to MM (Date)<span style="color:#F00; font-size:16px">****</span> </th>
						...
						<tr>
							...
							<td><input type="text" name="search_grade" value="Fabric Type" class="search_init" /></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td>
								<select name="dpd_concern_sample_coordinator_name[]" id="dpd_concern_sample_coordinator_name[]" style="font-size:11px" autofocus required>
							...
							<td> <?php echo $row['dpd_fabric_actual_date'] ; ?><input name="dpd_fabric_actual_date[]" class="rounded" type="hidden" id="dpd_fabric_actual_date[]" value="<?php echo $row['dpd_fabric_actual_date'] ; ?>" placeholder="dd-mm-yyyy" tabindex="8" onclick="showCalendarControl(this);" /></td>
							...
							<td>
								<input name="dpd_sample_planned_date[]" class="rounded" type="text" id="dpd_sample_planned_date[]" value="<?php echo $row['dpd_sample_planned_date'] ; ?>" placeholder="dd-mm-yyyy" tabindex="2" onClick="showCalendarControl(this);" />
							</td>
							...
							<td>
								<input name="dpd_fabric_planned_date[]" class="rounded" type="text" id="dpd_fabric_planned_date[]"
									value="<?php echo $row['dpd_fabric_planned_date'] ; ?>" placeholder="dd-mm-yyyy" tabindex="2" onclick="showCalendarControl(this);" />
							</td>
