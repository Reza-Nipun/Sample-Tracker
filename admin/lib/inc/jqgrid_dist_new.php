 ...
 * @version 1.5.2 build 20140402-1619
	...
	function set_options($options)
	{
		...
		if ($this->options["form"]["position"] == "center")
		{
			...
			$this->options["search_options"]["beforeShowSearch"] .= 'function(formid) { 
																		...
																		jQuery("#searchmodfbox_" + gid).abscenter();
																	}
																';
		...
		if ($this->actions["rowactions"] !== false)
		{
			...
			if ($this->internal["actionicon"] === true) // icons as action links
			{
				...
				if ($this->actions["delete"] !== false)
					$act_links[] = "<a class=\"ui-custom-icon ui-icon ui-icon-trash\" title=\"Delete this row\" href=\"javascript:void(0);\" onclick=\"jQuery(\'#$grid_id\').delGridRow(\''+cl+'\'); jQuery(\'#delmod$grid_id\').abscenter(); \"></a>";
			...
			if ($this->actions["delete"] !== false)
				$act_links[] = "<a title=\"Delete this row\" href=\"javascript:void(0);\" onclick=\"jQuery(\'#$grid_id\').delGridRow(\''+cl+'\'); jQuery(\'#delmod$grid_id\').abscenter(); \">Delete</a>";
