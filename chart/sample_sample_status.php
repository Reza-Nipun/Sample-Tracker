...
FROM  `tb_track_info` where customer='$tid' AND sd_sample_reject_pass='pass'"; 
//die($SQL);
...
//,$t1,$t2   
  ...
  ?> 
        ...
        var options = {
          title:'Sample Status Pass Chart',
          hAxis: {title: 'Buyer'},
          vAxis: {title: 'Ammount'},
		  'colors':['green'],
	 ...
	 window.open("chart_details.php?customer=" + element + "&chk1=" + 1 +"","mywindow","menubar=1,resizable=1,width=700,height=490,left=20,top=90,location=yes");
	  colors:['red','#004411'];
