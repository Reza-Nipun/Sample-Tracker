...
$SQL="SELECT COUNT( * ) as pa,sd_sample_reject_pass
FROM  `tb_track_info` 
GROUP BY  `sd_sample_reject_pass` order by `sd_sample_reject_pass` ASC"; 
...
echo "['$tid',$tid2],";   
  ...
  ?> 
        ...
        chart.draw(data, {title:"" ,  is3D: true,'colors':['#FF9900','#FFFFFF','#FF00FF','#006600','#FF0000']});
	...
	//	window.open ("a.php?ID=<?php // echo $element ; ?>&ID1=<?php // echo $tid2 ; ?>&ID2=<?php // echo $tid3 ; ?>","mywindow","menubar=1,resizable=1,width=550,height=450");
	 ...
	 window.open("chart_details.php?status=" + element + "","mywindow","menubar=1,resizable=1,width=1000,height=590,left=20,top=90,location=yes");
	  colors:['red','#000000'];
  ...
  <body bgcolor="" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="font-family: Arial;border: 0 none;">
