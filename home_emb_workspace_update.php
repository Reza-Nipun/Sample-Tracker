...
<table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:1500px; padding-bottom: 10px; background-color: #FFF; color: #FC0;">
    ...
    <th align="center" style="width:60px; background-color:#CCCCFF">Emb. Cut Panel Rcv</th>
	...
	?>
		...
		<tr class="gradeA">
		  ...
		  <td><input name="emb_cut_panel[]" onClick="select()" value="<?php echo $row['emb_cut_panel'] ; ?>" size="15px" tabindex="1"></td>
		  ...
		  <td><select name="emb_status[]" tabindex="4">
