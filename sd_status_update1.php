...
$sd_actual_sample_submission_date=$_POST['sd_actual_sample_submission_date'][$rowz] ;	
	...
	$SQL="UPDATE  `tb_track_info` SET sd_actual_sample_submission_date='$sd_actual_sample_submission_date',
	sd_sample_reject_pass='$sd_sample_reject_pass',cmt_sd='$cmt_sd',update_sd_id='$update_dpd' WHERE  `tb_track_info`.`sl` ='$checkbox' ";
	...
	<body>
		...
		<div id="demo" style="margin-top:20px; ">
				...
				<table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:100% !important; padding-bottom: 10px; background-color: #FFF; color: #FC0;">
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td class="center"><textarea name="cmt_dpd[]" id="cmt_dpd[]" cols="15" rows="2"><?php echo $row['cmt_sd'] ; ?></textarea></td>
							<td class="center">
          ...
          <option value="No Comments (Customer reference sample)">No Comments (Customer reference sample)</option>
								...
								<input name="udate_dpd[]" id="udate_dpd[]" type="hidden" value="<?php echo $row['update_sd_id'] ; ?>,<?php echo $uid ; ?>">
						  </td>
						</tr>
						<?php
							$sl++ ;
