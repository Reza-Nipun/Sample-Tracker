...
<td><?php echo $row['sd_concern_dpd_name'] ; ?></td>
     ...
     <span id="sto_<?php echo $row['sll']; ?>"><?php if ($row['cancel_sto'] != '') { ?>Prev STO: <?php echo $row['cancel_sto']; } else echo 'No Prev STO';?></span>
						...
						<input type="text" class="editbox" onClick="this.select()" onFocus="this.select()" id="first_input_<?php echo $row['sll']; ?>" value="<?php echo $row['sto_po_no']; ?>" size="11" maxlength="15" />
