...
<?php
	...
	$SQL="UPDATE  `tb_fabric_booking` SET  knit_comnt =  '$knit_comnt',
knit_status = '$knit_status' WHERE  `tb_fabric_booking`.`sl` ='$slid'" ;
...
<h2 align="center"> Knitting Comment Update</h2>

<br />
<?php echo $msg ; ?>

<form action="home_knit_cmt_update.php" method="post">
...
//die($SQL);
  ...
  <tr>
    <td bgcolor="#E5E5E5" scope="row">Knit Comment</td>
    <td scope="row"><textarea name="knit_comnt" id="knit_comnt"><?php echo $row['knit_comnt'] ; ?></textarea></td>
  </tr>
  <tr>
    <td bgcolor="#E5E5E5" scope="row">Knit Status</td>
