...
$mm_trims_actual_date = $_POST['mm_trims_actual_date'][$rowz] ;
$fab_receive_actual_date= $_POST['fab_receive_actual_date'][$rowz] ;

$update_mm= $_POST['udate_mm'][$rowz] ;




$SQL="UPDATE  `tb_track_info` SET  mm_fabricbooking_by_dpd_to_mm_date= '$mm_fabricbooking_by_dpd_to_mm_date',
mm_trims_actual_date = '$mm_trims_actual_date',
fab_receive_actual_date='$fab_receive_actual_date',
update_mm_id='$update_mm'
 WHERE  `sl` ='$checkbox' ";
...
<form action="home_mm_update1.php" method="post">           
	...
	?>
		...
		<tr class="gradeA">
		  <td width=""><?php echo $sl ; ?> </td>
			...
			<td><input name="fab_receive_actual_date[]" class="rounded" type="text" id="fab_receive_actual_date[]" value="<?php echo $row['fab_receive_actual_date'] ; ?>" placeholder="dd-mm-yyyy" tabindex="1" onClick="showCalendarControl(this);" /></td>
			<td>
