...
<body>
   ...
   <div class="span12">
                                <h2>Cancel Fabric Booking by DPD</h2>
...
<table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:4000px !important; padding-bottom: 10px; background-color: #FFF; color:#000;">
    ...
    <th><strong>Cancel Rsn</strong></th>
    <th><strong>Revise Rsn</strong></th>
    <th><strong>Cancel Cmnts</strong></th>
	</tr>
...
//	$SQL="select *,a.sl as sll,a.color_code as c_code from tb_fabric_booking a,tb_track_info b WHERE b.sd_concern_mm_name='$user_name' AND a.sample_style=b.style AND b.color=a.color";    //table name
	...
	// $sql="select a.*,a.sl as sll,a.sample_style,a.color_code as c_code,b.sd_concern_mm_name,b.customer,b.fab_receive_planned_date,b.sd_sample_type_name,b.sd_agreed_sample_delivery_date from tb_fabric_booking a,tb_track_info b WHERE a.sample_style=b.style AND b.color=a.color ";    //table name
	
	$sql="select a.*,a.sl as sll,a.sample_style,a.color_code as c_code,b.sd_concern_mm_name,b.customer,b.fab_receive_planned_date,b.sd_sample_type_name,b.sd_agreed_sample_delivery_date from tb_fabric_booking a,tb_track_info b WHERE a.track_info_sl=b.sl";    //table name
...
if($sys_date!='')
{
	 $sql= $sql . " AND a.cancel_status <> 0 group by a.sl order by sll ASC " ;
}
//	echo $sql ;
...
$result = $obj->sql($sql);
	...
	?>
  <tr id="<?php echo $row['sll'] ; ?>" style="color:#F00">
    ...
    <td bgcolor="#FFCC00" style="color:#000"><?php echo $row['sto_po_no']?></td>
    <td bgcolor="#FFCC00" style="color:#000"><?php echo $row['mm_date']?></td>
    <td bgcolor="#3399FF" style="color:#000"><?php echo $row['knit_del_qty']?></td>
    <td bgcolor="#3399FF" style="color:#000"><?php echo $row['knit_comnt']?></td>
    <td bgcolor="#3399FF" style="color:#000"><?php echo $row['knit_status']?></td>
    <td bgcolor="#3399FF" style="color:#000"><?php echo $row['knit_date']?></td>
    <td bgcolor="#CCCCFF" style="color:#000"><?php echo $row['delv_qty']?></td>
    <td bgcolor="#CCCCFF" style="color:#000"><?php  echo $row['remark_dy'];  ?></td>
    <td bgcolor="#CCCCFF" style="color:#000"><?php echo $row['del_status'] ;  ?></td>
    <td bgcolor="#CCCCFF" style="color:#000"><?php echo $row['dy_date'] ;  ?></td>
    <td bgcolor="#FF99CC" style="color:#000"><?php echo $row['store_rec_qty'] ;  ?></td>
    <td bgcolor="#FF99CC" style="color:#000"><?php echo $row['store_status'] ;  ?></td>
    <td bgcolor="#FF99CC" style="color:#000"><?php echo $row['store_date'] ;  ?></td>       
