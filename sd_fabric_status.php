...
<input name="date" class="rounded" type="text" id="date" placeholder="dd-mm-yyyy" tabindex="2" onclick="showCalendarControl(this);" autofocus required /></td>
  ...
  <table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:3800px !important; padding-bottom: 10px; background-color: #FFF; color:#000;">
    ...
    <th bgcolor="#FFFF99">Fab Booking Date</th>
    ...
    <th bgcolor="#CCFFFF">Job Ref. No</th>
    ...
    <th bgcolor="#FF99CC">Store Date</th>
		...
		<td><input type="text" name="Sample Delv Date" size="5" value="Sample Delv Date" class="search_init" /></td>
			...
			<td><input type="text" name="Planned Date" size="6" value="Planned Date" class="search_init" /></td>
			<td><input type="text" name="Item" size="6" value="Item" class="search_init" /></td>
			<td><input type="text" name="LabDip Status" size="6" value="LabDip Status" class="search_init" /></td>
			<td><input type="text" name="Spcl Comment" size="6" value="Spcl Comment" class="search_init" /></td>
			<td><input type="text" name="Fab Req Qty" size="6" value="Fab Req Qty" class="search_init" /></td>
			<td><input type="text" name="UOM" size="6" value="UOM" class="search_init" /></td>
			<td><input type="text" name="STO PO NO" size="6" value="STO PO NO" class="search_init" /></td>
			<td><input type="text" name="Job No" size="6" value="Job No" class="search_init" /></td>
			...
			<td><input type="text" name="DY Cmnt" size="6" value="DY Cmnt" class="search_init" /></td>
			<td><input type="text" name="DY Status" size="6" value="DY Status" class="search_init" /></td>
			<td><input type="text" name="DY Date" size="6" value="DY Date" class="search_init" /></td>
			<td><input type="text" name="DPD Rmrks" size="6" value="DPD Rmrks" class="search_init" /></td>
			...
			<td><input type="text" name="Yarn" size="6" value="Yarn" class="search_init" /></td>
...
//	$results = $obj->sql($SQL);
	...
	$sql="select a.*,a.sl as sll,b.sd_concern_dpd_name,b.brand_style,b.fab_receive_planned_date,b.sd_agreed_sample_delivery_date,b.sd_sample_type_name,b.customer,a.color_code as c_code from tb_fabric_booking a,tb_track_info b WHERE b.sd_concern_sd_name='$user_name' AND b.sl=a.track_info_sl";    //table name
...
while($row = mysql_fetch_array($result))
    ...
    <td bgcolor="#CCFFFF"><?php echo $row['referrence_id']; ?></td>
