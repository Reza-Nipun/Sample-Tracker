...
<html>
	...
	<body>
		...
		<div id="demo" style="margin-top:20px; ">
			<form action="sd_status_update1.php" method="post" enctype="multipart/form-data">
				<table cellpadding="0" cellspacing="0" border="1" class="draggable" id="example" style="width:100% !important; padding-bottom: 10px; background-color: #FFF; color: #FC0;">
					...
					<tbody>
						...
						<tr class="gradeA">
							...
							<td class="center"><textarea name="cmt_sd[]" id="cmt_sd[]" cols="15" rows="2"><?php echo $row['cmt_sd'] ; ?></textarea></td>
							<td class="center">
